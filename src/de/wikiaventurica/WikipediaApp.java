...
public class WikipediaApp extends Application {
	...
	private void migrateDatabaseFromvc1() {
		...
		File v1File = new File("/data/data/" + getPackageName() + "/databases/savedPagesDB.db");
		File v10File = new File("/data/data/" + getPackageName() + "/app_database:savedPagesDB.db");
		if (!v1File.exists()) {
		...
		SQLiteDatabase v10Db = SQLiteDatabase.openDatabase(v10File.getAbsolutePath(), null,
